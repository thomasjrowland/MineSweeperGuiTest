...
public class GUI extends JFrame {
	...
	public GUI() {
		this.setTitle("MineSweeper"); 	//game title in window
		this.setSize(1286, 829); 		//pixel dimensions of window (Height adds 29px to account for the title bar)(width add 3 per side)
...
//					if (mines[i][j] == 1) {   		//will display all mine locations
